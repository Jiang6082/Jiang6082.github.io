...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "A leakage-controlled ML pipeline that forecasts next-day realized volatility for 14 US ETFs, benchmarking gradient-boosted trees and a neural net against econometric baselines (HAR, Ridge) under a strict walk-forward evaluation. All reported numbers are generated by the pipeline, not hand-typed.",
    language: "Python",
    topics: ["python", "machine-learning", "volatility", "time-series"],
    visibility: "public",
    repo: "https://github.com/Jiang6082/market-volatility-forecasting",
  },
  {
    name: "Project-Olsen",
    description:
