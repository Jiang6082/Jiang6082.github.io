...
The manager runs only on your computer. Changes appear in the local website preview; they reach the public site only after the website is published. Keep the manager running while using it. Restart it with the same command when needed.
